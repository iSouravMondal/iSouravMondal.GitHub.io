...
! function(e, n, t, o) {
    ...
    e.fn.pagepiling = function(i) {
        var a, s = e.fn.pagepiling,
            c = e(this),
            r = 0,
            l = "ontouchstart" in t || navigator.msMaxTouchPoints > 0 || navigator.maxTouchPoints,
            p = 0,
            d = 0,
            v = 0,
            h = 0,
        ...
        e.extend(e.easing, {
            ...
            e ? c.get(0).addEventListener ? (c.get(0).addEventListener("mousewheel", k, !1), c.get(0).addEventListener("wheel", k, !1)) : c.get(0).attachEvent("onmousewheel", k) : c.get(0).addEventListener ? (c.get(0).removeEventListener("mousewheel", k, !1), c.get(0).removeEventListener("wheel", k, !1)) : c.get(0).detachEvent("onmousewheel", k)
        }, s.setAllowScrolling = function(e) {
            e ? (s.setMouseWheelScrolling(!0), function() {
                if (l) {
                    var e = I();
                    c.off("touchstart " + e.down).on("touchstart " + e.down, Y), c.off("touchmove " + e.move).on("touchmove " + e.move, N)
                }
            }()) : (s.setMouseWheelScrolling(!1), function() {
                if (l) {
                    var e = I();
            ...
            !n.length && m.loopTop && (n = e(".pp-section").last()), n.length && S(n)
        }, s.moveSectionDown = function() {
            var n = e(".pp-section.active").next(".pp-section");
            !n.length && m.loopBottom && (n = e(".pp-section").first()), n.length && S(n)
        }, s.moveTo = function(t) {
            var o = "";
            (o = isNaN(t) ? e(n).find('[data-anchor="' + t + '"]') : e(".pp-section").eq(t - 1)).length > 0 && S(o)
        }, e(m.sectionSelector).each(function() {
            e(this).addClass("pp-section")
        }), m.css3 && (m.css3 = function() {
            ...
            for (var s in n.body.insertBefore(i, null), a) i.style[s] !== o && (i.style[s] = "translate3d(1px,1px,1px)", e = t.getComputedStyle(i).getPropertyValue(a[s]));
            return n.body.removeChild(i), e !== o && e.length > 0 && "none" !== e
        }()), e(c).css({
            overflow: "hidden",
            "-ms-touch-action": "none",
            "touch-action": "none"
        }), s.setAllowScrolling(!0), e.isEmptyObject(m.navigation) || function() {
            e("body").append('<div id="pp-nav"><ul></ul></div>');
            var n = e("#pp-nav");
            n.css("color", m.navigation.textColor), n.addClass(m.navigation.position);
            for (var t = 0; t < e(".pp-section").length; t++) {
                var o = "";
                if (m.anchors.length && (o = m.anchors[t]), "undefined" !== m.navigation.tooltips) {
        ...
        function S(n, t) {
            var o, i = {
                ...
                toMove: n,
                yMovement: (o = n, e(".pp-section.active").index(".pp-section") > o.index(".pp-section") ? "up" : "down"),
                leavingSection: e(".pp-section.active").index(".pp-section") + 1
            };
            if (!i.activeSection.is(n)) {
                var s, c, l;
                void 0 === i.animated && (i.animated = !0), void 0 !== i.anchorLink && (s = i.anchorLink, c = i.sectionIndex, m.anchors.length ? (location.hash = s, M(location.hash)) : M(String(c))), i.destination.addClass("active").siblings().removeClass("active"), i.sectionsToMove = function(n) {
                        var t;
                        t = "down" === n.yMovement ? e(".pp-section").map(function(t) {
                            if (t < n.destination.index(".pp-section")) return e(this)
                        }) : e(".pp-section").map(function(t) {
                            if (t > n.destination.index(".pp-section")) return e(this)
                        });
                        return t
                    }(i), "down" === i.yMovement ? (i.translate3d = q(), i.scrolling = "-100%", m.css3 || i.sectionsToMove.each(function(n) {
                        n != i.activeSection.index(".pp-section") && e(this).css(x(i.scrolling))
                    }), i.animateSection = i.activeSection) : (i.translate3d = "translate3d(0px, 0px, 0px)", i.scrolling = "0", i.animateSection = n), e.isFunction(m.onLeave) && m.onLeave.call(this, i.leavingSection, i.sectionIndex + 1, i.yMovement),
                    function(n) {
                        m.css3 ? (T(n.animateSection, n.translate3d, n.animated), n.sectionsToMove.each(function() {
                            T(e(this), n.translate3d, n.animated)
                        }), setTimeout(function() {
                            w(n)
                        }, m.scrollingSpeed)) : (n.scrollOptions = x(n.scrolling), n.animated ? n.animateSection.animate(n.scrollOptions, m.scrollingSpeed, m.easing, function() {
                            b(n), w(n)
                        }) : (n.animateSection.css(x(n.scrolling)), setTimeout(function() {
                            b(n), w(n)
                        }, 400)))
                    }(i), l = i.anchorLink, m.menu && (e(m.menu).find(".active").removeClass("active"), e(m.menu).find('[data-menuanchor="' + l + '"]').addClass("active")),
                    function(n, t) {
                        m.navigation && (e("#pp-nav").find(".active").removeClass("active"), n ? e("#pp-nav").find('a[href="#' + n + '"]').addClass("active") : e("#pp-nav").find("li").eq(t).find("a").addClass("active"))
                    }(i.anchorLink, i.sectionIndex), a = i.anchorLink;
        ...
        function w(n) {
            e.isFunction(m.afterLoad) && m.afterLoad.call(this, n.anchorLink, n.sectionIndex + 1)
        }
        ...
        function T(e, n, t) {
            e.toggleClass("pp-easing", t), e.css(function(e) {
                return {
                    "-webkit-transform": e,
                    "-moz-transform": e,
                    "-ms-transform": e,
        ...
        e(".pp-section").each(function(n) {
            e(this).data("data-index", n), e(this).css("z-index", g), n || 0 !== e(".pp-section.active").length || e(this).addClass("active"), void 0 !== m.anchors[n] && e(this).attr("data-anchor", m.anchors[n]), void 0 !== m.sectionsColor[n] && e(this).css("background-color", m.sectionsColor[n]), m.verticalCentered && !e(this).hasClass("pp-scrollable") && e(this).addClass("pp-table").wrapInner('<div class="pp-tableCell" style="height:100%" />'), g -= 1
        }).promise().done(function() {
            m.navigation && (e("#pp-nav").css("margin-top", "-" + e("#pp-nav").height() / 2 + "px"), e("#pp-nav").find("li").eq(e(".pp-section.active").index(".pp-section")).find("a").addClass("active")), e(t).on("load", function() {
                var o, i;
                o = t.location.hash.replace("#", ""), (i = e(n).find('.pp-section[data-anchor="' + o + '"]')).length > 0 && S(i, m.animateAnchor)
            }), e.isFunction(m.afterRender) && m.afterRender.call(this)
        }), e(t).on("hashchange", function() {
            var o = t.location.hash.replace("#", "").split("/")[0];
            if (o.length) {
                if (o && o !== a) S(isNaN(o) ? e(n).find('[data-anchor="' + o + '"]') : e(".pp-section").eq(o - 1))
            }
        }), e(n).keydown(function(n) {
            if (m.keyboardScrolling && !y()) switch (n.which) {
                case 38:
                case 33:
                    s.moveSectionUp();
                    break;
        ...
        }), m.normalScrollElements && (e(n).on("mouseenter", m.normalScrollElements, function() {
        ...
        function k(n) {
            ...
            if (C = o, r > 200 && (u = []), !y()) {
                ...
                return E(u, 10) >= E(u, 70) && c && (a < 0 ? L("down", l) : a > 0 && L("up", l)), !1
            }
        }
        ...
        function L(e, n) {
            var t, o;
            if ("down" == e ? (t = "bottom", o = s.moveSectionDown) : (t = "top", o = s.moveSectionUp), n.length > 0) {
                if (! function(e, n) {
                        if ("top" === e) return !n.scrollTop();
                        if ("bottom" === e) return n.scrollTop() + 1 + n.innerHeight() >= n[0].scrollHeight
                    }(t, n)) return !0;
                o()
            } else o()
        }
        ...
        function X(e) {
            var n = new Array;
            return n.y = void 0 !== e.pageY && (e.pageY || e.pageX) ? e.pageY : e.touches[0].pageY, n.x = void 0 !== e.pageX && (e.pageY || e.pageX) ? e.pageX : e.touches[0].pageX, n
        }
        ...
        function N(n) {
            ...
            if (! function n(t, o) {
                    o = o || 0;
                    var i = e(t).parent();
                    return !!(o < m.normalScrollElementTouchThreshold && i.is(m.normalScrollElements)) || o != m.normalScrollElementTouchThreshold && n(i, ++o)
                }(n.target) && P(t)) {
                var o = D(e(".pp-section.active"));
                if (o.length || n.preventDefault(), !y()) {
                    var i = X(t);
                    v = i.y, h = i.x, "horizontal" === m.direction && Math.abs(d - h) > Math.abs(p - v) ? Math.abs(d - h) > c.width() / 100 * m.touchSensitivity && (d > h ? L("down", o) : h > d && L("up", o)) : Math.abs(p - v) > c.height() / 100 * m.touchSensitivity && (p > v ? L("down", o) : v > p && L("up", o))
                }
            }
        }

        function q() {
            return "vertical" !== m.direction ? "translate3d(-100%, 0px, 0px)" : "translate3d(0px, -100%, 0px)"
        }
        e(n).on("click touchstart", "#pp-nav a", function(n) {
            ...
            mouseenter: function() {
                ...
                e('<div class="pp-tooltip ' + m.navigation.position + '">' + n + "</div>").hide().appendTo(e(this)).fadeIn(200)
            },
            mouseleave: function() {
